...
import type { BlockDashboardProps } from "../types/components";

const BlockDashboard = ({ setIsLoading, setIsError }: BlockDashboardProps) => {
			...
			<Content className="dashboard-content">
				<TopButtonContainer>
					...
					<Button
						...
						handleClick={() => handleCreateLineBlock(lineBlocks)}
					/>
				</TopButtonContainer>
				<LineBlockList>
